...
- リアルタイムプレビュー
- カーニング情報や OpenType 機能の保持
- ライセンス情報等のメタデータの自動的な統合

### フォントデータの書き出し形式

デスクトップ用フォントデータ、Web 表示用の軽量フォントデータが同時生成されます。

- `.otf` / `.ttf`: デスクトップ用。PC にインストールして使用できます。
  - 入力に対し最適な形式が選ばれます
- `.woff2`: Web サイト用。サーバーにアップロードして使用できます。
...
<a href="https://fonts.google.com/" target="_blank" rel="noopener noreferrer">Google Fonts ↗︎</a> や <a href="https://www.collletttivo.it/typefaces" target="_blank" rel="noopener noreferrer">Collletttivo ↗︎</a>、<a href="https://github.com/googlefonts/noto-fonts" target="_blank" rel="noopener noreferrer">Noto フォントファミリー ↗︎</a>など、多くの高品質な書体が OFL のもとで公開されています。
...
Apple Silicon 搭載の Mac (arm64) 専用です。  
過去バージョンは [Releases](https://github.com/yamatoiizuka/ofl-font-baker/releases) ページを参照してください。
...
OFL の詳細については、<a href="https://openfontlicense.org" target="_blank" rel="noopener noreferrer">SIL Open Font License 公式サイト ↗︎</a> を参照してください。
...
なお、本アプリは Electron ベースで開発しているため、将来的には Windows 版や Intel 搭載 Mac 向けの対応を行う可能性があります。これらの対応を後押ししていただける場合は、<a href="https://www.buymeacoffee.com/yamatoiizuka" target="_blank" rel="noopener noreferrer">Buy Me a Coffee ↗︎</a> や GitHub Sponsors からサポートしていただけると励みになります。

### ライセンス

このソフトウェアは <a href="https://www.gnu.org/licenses/agpl-3.0.html" target="_blank" rel="noopener noreferrer">GNU Affero General Public License v3.0 ↗︎</a>（AGPL）のもとで公開されています。
...
また、コアロジックを含む `python/` ディレクトリ内のソースコードは MIT License で提供されており、PyPI から単体の Python パッケージとして利用できます。  
...
このアプリケーションは、<a href="https://www.anthropic.com/claude" target="_blank" rel="noopener noreferrer">Claude Opus 4.6 ↗︎</a> との対話を通じて設計・開発されました。

フォントマージの中核には <a href="https://github.com/fonttools/fonttools" target="_blank" rel="noopener noreferrer">fontTools ↗︎</a>、リアルタイムプレビューには <a href="https://github.com/harfbuzz/harfbuzzjs" target="_blank" rel="noopener noreferrer">HarfBuzz ↗︎</a> を使用しています。
